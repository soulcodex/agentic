...
# T01 — compose: typescript-hexagonal-microservice
run_test "T01 — compose: typescript-hexagonal-microservice"
bash "$COMPOSE" \
  --library "$LIBRARY" \
...
assert_file_contains "$TMP/t01/AGENTS.md" "## Git Conventions" "T01"
assert_file_contains "$TMP/t01/AGENTS.md" "## TypeScript" "T01"
assert_file_contains "$TMP/t01/AGENTS.md" "## Hexagonal Architecture" "T01"
assert_file_exists "$TMP/t01/.agentic/config.yaml" "T01"

# T02 — compose: go-hexagonal-microservice
run_test "T02 — compose: go-hexagonal-microservice"
bash "$COMPOSE" \
  --library "$LIBRARY" \
...
assert_file_contains "$TMP/t02/AGENTS.md" "## Go" "T02"
assert_file_not_contains "$TMP/t02/AGENTS.md" "## TypeScript" "T02"
